...
namespace read_d2c_messages
{
    class ReadDeviceToCloudMessages
    {
        ...
        private readonly static string s_eventHubsCompatibleEndpoint = "sb://iothub-ns-contosotes-888888-xxxxxxxxxx.servicebus.windows.net/";

        // Event Hub-compatible name
        // az iot hub show --query properties.eventHubEndpoints.events.path --name {your IoT Hub name}
        private readonly static string s_eventHubsCompatibleName = "{your IoT Hub name}";
        
        // az iot hub policy show --name iothubowner --query primaryKey --hub-name {your IoT Hub name}
        private readonly static string s_iotHubSasKey = "{ IoTHub Key }";
        ...
        private static async Task Main(string[] args)
        {
            ...
            var connectionString = new EventHubsConnectionStringBuilder(new Uri(s_eventHubsCompatibleEndpoint), s_eventHubsCompatibleName, s_iotHubSasKeyName, s_iotHubSasKey);
